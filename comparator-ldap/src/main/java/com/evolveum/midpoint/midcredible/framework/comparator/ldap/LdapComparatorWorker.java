...
import com.evolveum.midpoint.midcredible.framework.comparator.common.CsvReportPrinter;
...
public class LdapComparatorWorker implements Runnable {
    ...
    private void printCsvRow(CsvReportPrinter printer, Map<Column, List<ColumnValue>> changes) throws IOException {
        ...
        Map<String, com.evolveum.midpoint.midcredible.framework.comparator.common.Attribute> attributes = new HashMap<>();
        ...
        for (Map.Entry<Column, List<ColumnValue>> entry : changes.entrySet()) {
            ...
            com.evolveum.midpoint.midcredible.framework.comparator.common.Attribute attr =
                    new com.evolveum.midpoint.midcredible.framework.comparator.common.Attribute(entry.getKey().getName());
    ...
    private void printCsvRow(CsvReportPrinter printer, RowState rowState, Map<Column, Set<Object>> entry) throws IOException {
        ...
        for (Map.Entry<Column, Set<Object>> e : entry.entrySet()) {
            ...
            com.evolveum.midpoint.midcredible.framework.comparator.common.Attribute attr =
                    new com.evolveum.midpoint.midcredible.framework.comparator.common.Attribute(attrName);
